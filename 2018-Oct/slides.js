...
var _user$project$DiveSvg_Model$duration = 2000;
var _user$project$DiveSvg_Model$Model = F4(
	function (a, b, c, d) {
		return {current: a, frames: b, animation: c, slides: d};
	});
var _user$project$DiveSvg_Model$init = function (current) {
	return A4(
		_user$project$DiveSvg_Model$Model,
		current,
		{ctor: '[]'},
		_elm_lang$core$Maybe$Nothing,
		_elm_lang$core$Basics$always(
...
var _user$project$DiveSvg_Model$Frame = F4(
	function (a, b, c, d) {
		return {x: a, y: b, w: c, h: d};
	});
var _user$project$DiveSvg_Model$Load = function (a) {
	return {ctor: 'Load', _0: a};
};
var _user$project$DiveSvg_Model$Back = {ctor: 'Back'};
var _user$project$DiveSvg_Model$Forth = {ctor: 'Forth'};
var _user$project$DiveSvg_Model$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};

var _user$project$DiveSvg_Parser$toAttr = _elm_lang$core$List$map(
	_elm_lang$core$Basics$uncurry(_elm_lang$virtual_dom$VirtualDom$attribute));
var _user$project$DiveSvg_Parser$frame2Viewbox = function (current) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$DiveSvg_Parser$matrix2Frame = function (_p0) {
	var _p1 = _p0;
	return A4(_user$project$DiveSvg_Model$Frame, _p1._2._0, _p1._2._1, _p1._0._0, _p1._1._1);
};
var _user$project$DiveSvg_Parser$frame2Matrix = function (_p2) {
	var _p3 = _p2;
	return {
		ctor: '_Tuple3',
...
var _user$project$DiveSvg_Parser$transformFrame = F2(
	function (matrix, frame) {
		return _user$project$DiveSvg_Parser$matrix2Frame(
			A2(
				_Zinggi$elm_webgl_math$Matrix3$mul,
				_user$project$DiveSvg_Parser$frame2Matrix(frame),
				matrix));
	});
var _user$project$DiveSvg_Parser$map6 = F7(
...
var _user$project$DiveSvg_Parser$floatRegex = _elm_lang$core$Regex$regex('[-+]?[0-9]*\\.?[0-9]+([eE][-+]?[0-9]+)?');
var _user$project$DiveSvg_Parser$numbers2 = function (op) {
	var _p8 = A3(
		_elm_lang$core$Regex$find,
		_elm_lang$core$Regex$AtMost(2),
		_user$project$DiveSvg_Parser$floatRegex,
		op);
	if (_p8.ctor === '::') {
		return A2(
...
var _user$project$DiveSvg_Parser$numbers6 = function (op) {
	...
	if ((((((_p11.ctor === '::') && (_p11._1.ctor === '::')) && (_p11._1._1.ctor === '::')) && (_p11._1._1._1.ctor === '::')) && (_p11._1._1._1._1.ctor === '::')) && (_p11._1._1._1._1._1.ctor === '::')) {
		return A7(
			_user$project$DiveSvg_Parser$map6,
			F6(
...
var _user$project$DiveSvg_Parser$op2Matrix = function (op) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		...
		A2(_elm_lang$core$String$startsWith, 'translate', op) ? A2(
			...
			_user$project$DiveSvg_Parser$numbers6(op)) : _elm_lang$core$Maybe$Nothing))))));
};
var _user$project$DiveSvg_Parser$attr2Matrix = function (attr) {
	var _p16 = A2(
			...
			F2(
				function (_p17, matrix) {
					...
					return A2(
						_Zinggi$elm_webgl_math$Matrix3$mul,
						matrix,
						_user$project$DiveSvg_Parser$op2Matrix(_p18.match));
				}),
			_Zinggi$elm_webgl_math$Matrix3$identity,
			A3(
				_elm_lang$core$Regex$find,
...
var _user$project$DiveSvg_Parser$findNumber = F2(
	function (child, result) {
		...
		if (_p19.ctor === 'Nothing') {
			...
			switch (_p20.ctor) {
				...
				case 'Element':
					return A3(_elm_lang$core$List$foldl, _user$project$DiveSvg_Parser$findNumber, _elm_lang$core$Maybe$Nothing, _p20._2);
				default:
					return _elm_lang$core$Maybe$Nothing;
			}
		} else {
...
var _user$project$DiveSvg_Parser$getFloat = F2(
	function (key, attr) {
		return A2(
			_elm_lang$core$Maybe$andThen,
			function (_p21) {
...
var _user$project$DiveSvg_Parser$foldFrame = F2(
	function (child, _p22) {
		var _p23 = _p22;
		var _p31 = _p23._0;
		var _p30 = _p23._1;
							...
							return A2(
								...
								function (width) {
									return A2(
										...
										function (height) {
											return _elm_lang$core$Maybe$Just(
												A4(_user$project$DiveSvg_Model$Frame, x, y, width, height));
										},
										A2(_user$project$DiveSvg_Parser$getFloat, 'height', attr));
								},
								A2(_user$project$DiveSvg_Parser$getFloat, 'width', attr));
						},
						A2(_user$project$DiveSvg_Parser$getFloat, 'y', attr));
				},
				A2(_user$project$DiveSvg_Parser$getFloat, 'x', attr));
		};
		var _p24 = child;
			...
			if (_elm_lang$core$Native_Utils.eq(_p29, 'rect')) {
				...
				if (_elm_lang$core$Native_Utils.eq(_p29, 'text')) {
					return {
						ctor: '_Tuple2',
						_0: function () {
							var _p27 = A3(_elm_lang$core$List$foldl, _user$project$DiveSvg_Parser$findNumber, _elm_lang$core$Maybe$Nothing, _p24._2);
							if (_p27.ctor === 'Just') {
...
var _user$project$DiveSvg_Parser$findFrame = F3(
	function (name, attr, children) {
		return (!_elm_lang$core$Native_Utils.eq(name, 'g')) ? {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _elm_lang$core$Maybe$Nothing} : A3(
			_elm_lang$core$List$foldl,
			_user$project$DiveSvg_Parser$foldFrame,
			{ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _elm_lang$core$Maybe$Nothing},
			children);
	});
var _user$project$DiveSvg_Parser$parseChild = F3(
			...
			case 'Element':
				if (_p32._0 === 'image') {
					return {
						...
						_0: {
							...
							_0: A3(
								...
								'image',
								_user$project$DiveSvg_Parser$toAttr(
									A2(
										_elm_lang$core$List$map,
										function (_p33) {
											var _p34 = _p33;
					...
					var parentTransformations_ = A2(
						_Zinggi$elm_webgl_math$Matrix3$mul,
						_user$project$DiveSvg_Parser$attr2Matrix(_p39),
						parentTransformations);
					var _p37 = A3(_user$project$DiveSvg_Parser$findFrame, _p41, _p39, _p40);
						...
						return {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: _p37._0._0,
									_1: A2(_user$project$DiveSvg_Parser$transformFrame, parentTransformations_, _p37._1._0)
								},
								_1: frames
							}
						};
					} else {
						var _p38 = A3(_user$project$DiveSvg_Parser$parse, frames, parentTransformations_, _p40);
						var nodes = _p38._0;
						var frames_ = _p38._1;
						return {
							ctor: '_Tuple2',
							_0: {
								...
								_0: A3(
									_elm_lang$svg$Svg$node,
									_p41,
									_user$project$DiveSvg_Parser$toAttr(_p39),
									nodes),
								_1: {ctor: '[]'}
							},
							_1: frames_
...
var _user$project$DiveSvg_Parser$parse = F3(
		...
		return A2(
			...
			A2(
				...
				_elm_lang$core$List$unzip(
					A2(
						_elm_lang$core$List$map,
						A2(_user$project$DiveSvg_Parser$parseChild, frames, parentTransformations),
						children))));
	});
var _user$project$DiveSvg_Parser$parseRoot = function (roots) {
	...
	if (((_p44.ctor === '::') && (_p44._0.ctor === 'Element')) && (_p44._0._0 === 'svg')) {
		var _p46 = _p44._0._1;
		var _p45 = A3(
			_user$project$DiveSvg_Parser$parse,
			{ctor: '[]'},
			_user$project$DiveSvg_Parser$attr2Matrix(_p46),
			_p44._0._2);
		var nodes = _p45._0;
		var frames = _p45._1;
		return {
			...
			_0: function (frame) {
				return A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$DiveSvg_Parser$toAttr(_p46),
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$viewBox(
								_user$project$DiveSvg_Parser$frame2Viewbox(frame)),
							_1: {
								ctor: '::',
...
var _user$project$DiveSvg_Parser$load = function (xml) {
	var _p47 = function (result) {
		...
		A2(
			...
			_user$project$DiveSvg_Parser$parseRoot,
	...
	if (_p50.ctor === '::') {
		return _elm_lang$core$Result$Ok(
			A4(_user$project$DiveSvg_Model$Model, _p50._0, _p50._1, _elm_lang$core$Maybe$Nothing, slides));
	} else {
		return _elm_lang$core$Result$Err('no frames found');
	}
};

var _user$project$DiveSvg_Sub$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: function () {
				...
				if (_p0.ctor === 'Nothing') {
					...
					return _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$DiveSvg_Model$Tick);
				}
			}(),
			_1: {
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$clicks(
					function (_p1) {
						return _user$project$DiveSvg_Model$Forth;
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$downs(
						function (code) {
							...
							switch (_p2) {
								case 37:
									return _user$project$DiveSvg_Model$Back;
								case 32:
									return _user$project$DiveSvg_Model$Forth;
								case 39:
									return _user$project$DiveSvg_Model$Forth;
								default:
									return _user$project$DiveSvg_Model$Tick(0);
							}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$DiveSvg_Update$update = F2(
	function (msg, model) {
		...
		var calcDiff = F3(
			function (progress, current, target) {
				return A4(_user$project$DiveSvg_Model$Frame, current.x + ((target.x - current.x) * progress), current.y + ((target.y - current.y) * progress), current.w + ((target.w - current.w) * progress), current.h + ((target.h - current.h) * progress));
			});
		var calcProgress = F2(
			function (oldProgress, diff) {
				return A2(
					...
					1,
					oldProgress + (diff / _elm_lang$core$Basics$toFloat(_user$project$DiveSvg_Model$duration)));
			});
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Load':
				var _p1 = A2(
					...
					_user$project$DiveSvg_Parser$load,
...
var _user$project$DiveSvg_View$view = function (_p0) {
	var _p1 = _p0;
...
var _user$project$Main$init = function (_p0) {
	...
	return {
		ctor: '_Tuple2',
		_0: _user$project$DiveSvg_Model$init(
			A4(_user$project$DiveSvg_Model$Frame, 0, 0, 0, 0)),
		_1: A2(
			_elm_lang$http$Http$send,
			_user$project$DiveSvg_Model$Load,
			_elm_lang$http$Http$getString(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'?',
						_elm_lang$core$Basics$toString(_p1.time)))))
	};
};
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Main$init, update: _user$project$DiveSvg_Update$update, subscriptions: _user$project$DiveSvg_Sub$subscriptions, view: _user$project$DiveSvg_View$view})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (file) {
			return A2(
